...
| 2 | Partial | health/readiness/scope/admin/metrics, auth/audit tests, fail-closed snapshot/events/checkpoint plus network WebSocket full-sync/resume/gap tests; bounded Rust MCP JSON-RPC transport with protocol negotiation, origin/media/body/batch gates, native `service_health`, Python/Rust golden definition and real TCP test | remaining legacy gateway proxy/golden route compatibility and 13 MCP tool dispatches |
