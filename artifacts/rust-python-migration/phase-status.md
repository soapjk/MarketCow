...
| 5 | Partial | UDS 0600 protocol; leased persistent job state/retry/cancel; pre-promotion lease authorization; Rust-only Artifact verification/promotion/registration; full Python poll/start/complete/fail loop; first deterministic SEC filing transform handler | remaining provider handlers, worker pool supervision/restart budgets, credential removal and deletion of Python public API dependency |
