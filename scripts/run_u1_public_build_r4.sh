...
test ! -e "$runtime/logs/public-api-build-r4.exit-code"
finish() { status=$?; printf '%s\n' "$status" > "$runtime/logs/public-api-build-r4.exit-code"; }
trap finish EXIT
cd /mnt/p44pro/projects/marketcow-shadow-v3
touch crates/marketcowd/src/source_discovery_projection.rs
