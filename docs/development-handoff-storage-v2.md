...
keyset 游标、无 OFFSET 的 DuckDB/ClickHouse 查询及同游标 fallback；修订候选移除公开默认
密钥，增加持久随机密钥、placeholder/长度拒绝和密钥轮换语义，并让 DuckDB 多来源选择
严格复用 canonical priority。10,001 行本地样本逐页验证有界、无缺失重复。尚未完成
