...
class V2AuthoritativeWriteError(RuntimeError):
    """Bounded online write failure; callers must never fallback to DuckDB."""


class V2AuthoritativeMarketBarRepository:
    ...
    def upsert_price_bars(
        ...
        if not result.get("acknowledged") or not result.get("verified"):
            ...
            raise V2AuthoritativeWriteError(
